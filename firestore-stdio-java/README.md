...
This will generate an executable JAR file in the `target` directory: `target/firestore-stdio-java-0.0.1-SNAPSHOT.jar`.
...
```bash
java -jar target/firestore-stdio-java-0.0.1-SNAPSHOT.jar
```
