...
This document outlines the coding standards and best practices for developers working on the `mcp-https-java` project.
...
- **Transport:** The project uses HTTP (SSE) transport via Spring WebFlux.
