...
This is a **C++ based Model Context Protocol (MCP) server** named `mcp-stdio-cplus`, implemented using the `cpp-mcp` library. It exposes a single tool (`greet`) over standard input/output (stdio) and logs structured JSON to stderr.
