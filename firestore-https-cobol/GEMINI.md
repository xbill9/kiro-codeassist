...
This is a **COBOL-based Model Context Protocol (MCP) server** named `firestore-https-cobol`, implemented using the `mcpc` library via C bindings. It exposes a single tool (`greet`) over **HTTP** and logs structured JSON to `stderr`.
